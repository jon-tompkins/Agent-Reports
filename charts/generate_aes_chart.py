...
plt.tight_layout()
plt.savefig(f'/home/ubuntu/clawd/Agent-Reports/charts/aes-price-{datetime.now().strftime("%Y-%m-%d")}.png', 
            dpi=150, bbox_inches='tight', facecolor='#1a1a2e', edgecolor='none')
print(f"Chart saved to /home/ubuntu/clawd/Agent-Reports/charts/aes-price-{datetime.now().strftime('%Y-%m-%d')}.png")