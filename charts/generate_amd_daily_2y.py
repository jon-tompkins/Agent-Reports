#!/usr/bin/env python3
"""Generate AMD daily 2-year price chart for deep dive report"""
...
ax1.plot(df.index, df['Close'], color='#ff6b6b', linewidth=2, label='AMD Price')
...
ax1.set_title('AMD - Daily Chart (2 Years)', fontsize=18, fontweight='bold', pad=20)
...
plt.tight_layout()
plt.savefig('/home/ubuntu/clawd/Agent-Reports/charts/AMD-daily-2y.png', 
            dpi=150, bbox_inches='tight', facecolor='#1a1a2e', edgecolor='none')
print(f"Daily 2Y chart saved to /home/ubuntu/clawd/Agent-Reports/charts/AMD-daily-2y.png")