#!/usr/bin/env python3
"""Generate BEP price chart for deep dive report"""
...
# Fetch BEP data - 1 year
ticker = yf.Ticker("BEP")
...
ax1.set_title('BEP (Brookfield Renewable Partners) - 1 Year Price Chart', fontsize=16, fontweight='bold', pad=20)
