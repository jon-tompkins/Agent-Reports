#!/usr/bin/env python3
"""Generate CVX price chart for deep dive report"""
...
# Fetch CVX data - 1 year
ticker = yf.Ticker("CVX")
...
ax1.set_title('CVX (Chevron Corporation) - 1 Year Price Chart', fontsize=16, fontweight='bold', pad=20)
...
plt.tight_layout()
plt.savefig('/home/ubuntu/clawd/Agent-Reports/charts/cvx-price-2026-02-07.png', 
            dpi=150, bbox_inches='tight', facecolor='#1a1a2e', edgecolor='none')
print(f"Chart saved to /home/ubuntu/clawd/Agent-Reports/charts/cvx-price-2026-02-07.png")
