#!/usr/bin/env python3
"""Generate ET price chart for deep dive report"""
...
ax1.set_title('ET (Energy Transfer LP) - 1 Year Price Chart', fontsize=16, fontweight='bold', pad=20)
