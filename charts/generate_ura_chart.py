#!/usr/bin/env python3
"""Generate URA price chart for deep dive report"""
...
ax1.set_title('URA (Global X Uranium ETF) - 1 Year Price Chart', fontsize=16, fontweight='bold', pad=20)
...
plt.tight_layout()
plt.savefig(f'/home/ubuntu/clawd/Agent-Reports/charts/ura-price-{datetime.now().strftime("%Y-%m-%d")}.png', 
            dpi=150, bbox_inches='tight', facecolor='#1a1a2e', edgecolor='none')
print(f"Chart saved to /home/ubuntu/clawd/Agent-Reports/charts/ura-price-{datetime.now().strftime('%Y-%m-%d')}.png")