...
plt.tight_layout()
plt.savefig('/home/ubuntu/clawd/Agent-Reports/charts/ura-price-2026-02-07.png', 
            dpi=150, bbox_inches='tight', facecolor='#1a1a2e', edgecolor='none')
print(f"Chart saved to /home/ubuntu/clawd/Agent-Reports/charts/ura-price-2026-02-07.png")